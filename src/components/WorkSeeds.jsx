    ...
    <div className={styles.page}>
      <header className={styles.header}>
        ...
        <p className={styles.lead}>
          Размышления и разборы, из которых потом быстрее собирать карточки и трансляции на
          странице <strong>Reflection</strong>. Это не поле обмена — запас смыслов и задач.
        </p>
      </header>
