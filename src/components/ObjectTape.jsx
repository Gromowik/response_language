...
const ObjectTape = ({ cards, onCardSelect, onCardEdit, onCardsReorder, onSendToCircular }) => {
  ...
  // Handle mouse wheel on scroll control (with passive: false to allow preventDefault)
  useEffect(() => {
    ...
    const handleWheelScroll = (e) => {
      ...
      if (delta > 0) {
        // Scroll down/right
        if (startIndex < cards.length - MAX_VISIBLE) {
    ...
    <div className={styles.container}>
      <div className={styles.controls}>
        ...
        {onSendToCircular && (
          <button 
            onClick={() => {
              // Send visible objects to Circular Tape
              // Focus object (rightmost visible) should be at top on circle
              onSendToCircular(cards, focusIndex);
            }}
        ...
        <div 
          ...
          title="Scroll tape with mouse wheel"
        >
