...
function App() {
  const [currentPage, setCurrentPage] = useState('horizontal') // 'horizontal', 'horizontal2', 'vertical', 'leftVertical', 'bothVertical', 'circular', 'bothCircular', 'pairedCircular', or 'philosophy'
